...
| 目录 | 说明 |
|------|------|
| [`dont-panic/`](dont-panic/) | **《别慌》** —— 原创单文件小游戏：移动躲避追逐者会让心跳升高，心跳越高追逐者越快越多；屏息能压平心跳但会失去行动力。网页版零依赖、浏览器打开 `index.html` 即玩；`douyin/` 子目录是同一玩法的抖音小游戏版（需自行注册抖音开放平台开发者账号，见该目录 README）。 |
